// KubeMQ .NET SDK — QueuesStream: Visibility Timeout
//
// This example demonstrates visibility timeout behavior via the stream API.
...
{
    ClientId = "csharp-queuesstream-visibility-timeout-client",
});
await client.ConnectAsync();

Console.WriteLine("Connected to KubeMQ server");

var channel = "csharp-queuesstream.visibility-timeout";
